...
//  MiotTask3HueLightControl
//
//  Created by Lee, John on 4/8/17.
...
class MainViewController: UIViewController {
    ...
    func addColorWheel() {
        ...
        colorWheel.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 75.0).isActive = true
    }
...
extension MainViewController: ColorWheelDelegate {
