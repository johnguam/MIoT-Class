...
- (IBAction)customizeLights:(id)sender {
    CustomLightsViewController *customLightsViewController = [[CustomLightsViewController alloc] initWithHueSDK:UIAppDelegate.phHueSDK];
        
    [self.navigationController presentViewController:customLightsViewController animated:YES completion:nil];
}
...
- (IBAction)randomizeColoursOfConnectLights:(id)sender{
    ...
    for (PHLight *light in cache.lights.allValues) {
        ...
        NSNumber *hue = [NSNumber numberWithInt:arc4random() % MAX_HUE];
        NSNumber *sat = [NSNumber numberWithInt:254];
        NSNumber *num = [NSNumber numberWithInt:254];
        [lightState setHue:hue];
        [lightState setBrightness:sat];
        [lightState setSaturation:num];
